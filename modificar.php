...
<head>
		...
		<form id="signupform" class="form-horizontal" role="form" action="update.php" method="POST" autocomplete="om" enctype="multipart/form-data">
  <div class="modal fade" id="dataModificar" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel">
